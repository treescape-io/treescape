...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('height_minimum', models.DecimalField(blank=True, decimal_places=2, max_digits=7, null=True, verbose_name='%(parent_verbose_name)s minimum')),
                ('height_typical', models.DecimalField(blank=True, decimal_places=2, max_digits=7, null=True, verbose_name='%(parent_verbose_name)s typical')),
                ('height_maximum', models.DecimalField(blank=True, decimal_places=2, max_digits=7, null=True, verbose_name='%(parent_verbose_name)s maximum')),
                ...
                ('width_minimum', models.DecimalField(blank=True, decimal_places=2, max_digits=7, null=True, verbose_name='%(parent_verbose_name)s minimum')),
                ('width_typical', models.DecimalField(blank=True, decimal_places=2, max_digits=7, null=True, verbose_name='%(parent_verbose_name)s typical')),
                ('width_maximum', models.DecimalField(blank=True, decimal_places=2, max_digits=7, null=True, verbose_name='%(parent_verbose_name)s maximum')),
                ...
                ('temperature_minimum', models.DecimalField(blank=True, decimal_places=2, max_digits=7, null=True, verbose_name='%(parent_verbose_name)s minimum')),
                ('temperature_typical', models.DecimalField(blank=True, decimal_places=2, max_digits=7, null=True, verbose_name='%(parent_verbose_name)s typical')),
                ('temperature_maximum', models.DecimalField(blank=True, decimal_places=2, max_digits=7, null=True, verbose_name='%(parent_verbose_name)s maximum')),
                ('temperature_confidence', species_data.fields.ConfidenceField(blank=True, decimal_places=1, max_digits=2, null=True, validators=[django.core.validators.MinValueValidator(0.0), django.core.validators.MaxValueValidator(1.0)], verbose_name='%(parent_verbose_name)s confidence')),
                ('precipitation_minimum', models.DecimalField(blank=True, decimal_places=2, max_digits=7, null=True, verbose_name='%(parent_verbose_name)s minimum')),
                ('precipitation_typical', models.DecimalField(blank=True, decimal_places=2, max_digits=7, null=True, verbose_name='%(parent_verbose_name)s typical')),
                ('precipitation_maximum', models.DecimalField(blank=True, decimal_places=2, max_digits=7, null=True, verbose_name='%(parent_verbose_name)s maximum')),
                ('precipitation_confidence', species_data.fields.ConfidenceField(blank=True, decimal_places=1, max_digits=2, null=True, validators=[django.core.validators.MinValueValidator(0.0), django.core.validators.MaxValueValidator(1.0)], verbose_name='%(parent_verbose_name)s confidence')),
                ('soil_acidity_minimum', models.DecimalField(blank=True, decimal_places=2, max_digits=7, null=True, verbose_name='%(parent_verbose_name)s minimum')),
                ('soil_acidity_typical', models.DecimalField(blank=True, decimal_places=2, max_digits=7, null=True, verbose_name='%(parent_verbose_name)s typical')),
                ('soil_acidity_maximum', models.DecimalField(blank=True, decimal_places=2, max_digits=7, null=True, verbose_name='%(parent_verbose_name)s maximum')),
                ...
                ('precipitation_source', species_data.fields.SourceField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='species_data.source', verbose_name='%(parent_verbose_name)s source')),
                ...
                ('species', models.OneToOneField(db_column='species_uuid', on_delete=django.db.models.deletion.CASCADE, related_name='properties', to='plant_species.species', to_field='uuid')),
                ...
                ('temperature_source', species_data.fields.SourceField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='species_data.source', verbose_name='%(parent_verbose_name)s source')),
