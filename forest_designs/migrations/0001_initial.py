# Generated by Django 5.0.4 on 2024-12-09 14:42
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('genus', models.ForeignKey(blank=True, db_column='genus_uuid', on_delete=django.db.models.deletion.PROTECT, to='plant_species.genus')),
                ('species', models.ForeignKey(blank=True, db_column='species_uuid', help_text='When specified, genus is automatically set.', null=True, on_delete=django.db.models.deletion.PROTECT, to='plant_species.species')),
                ('variety', models.ForeignKey(blank=True, db_column='variety_uuid', help_text='When specified, species and genus are automatically set.', null=True, on_delete=django.db.models.deletion.PROTECT, to='plant_species.speciesvariety')),
            ],
            options={
                'verbose_name': 'plant',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('kind', models.ForeignKey(db_column='plantimagekind_uuid', on_delete=django.db.models.deletion.PROTECT, to='forest_designs.plantimagekind')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('plant', models.ForeignKey(db_column='plant_uuid', on_delete=django.db.models.deletion.CASCADE, related_name='logs', to='forest_designs.plant')),
                ('kind', models.ForeignKey(db_column='plantlogkind_uuid', on_delete=django.db.models.deletion.PROTECT, to='forest_designs.plantlogkind')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('kind', models.ForeignKey(db_column='zonekind_uuid', on_delete=django.db.models.deletion.PROTECT, to='forest_designs.zonekind')),
            ],
            options={
                'verbose_name': 'zone',
